...
public class CommentController {
    ...
    public ResponseEntity<CustomResponse<?>> addComment(@RequestBody CommentRequestDto commentRequestDto) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(CustomResponse.makeResponse("Invalid input : Check ToDoListId or commentDto Content does not null", HttpStatus.BAD_REQUEST));
        }
    }
